...
To use the algorithm in R, we defined a function here, which was from the function in the JASP team's [GitHub](XXXX) and was used in [Yue et al (2023)](https://doi.org/10.17605/OSF.IO/MTR8D).
...
### The non-informative prior in case of sex ratio
...
HCP: need more explanations here for all the code below. To show the sensitivity of BF, we need to varying the priors, fixed the data, and plot the relation between BFs (or logBFs) and priors. I saw the plot in the response letter, it would be better to explain the code and show the plot here (in html?) too.
