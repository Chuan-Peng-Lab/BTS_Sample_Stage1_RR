...
main_plt <- main_data %>%
  ...
  geom_text(data = . %>% group_by(group) %>% slice(1),
            ...
            family = "Times", parse = TRUE, hjust = 0) +
  ...
  annotate("rect",
           xmin = x_zoom_range[1], xmax = x_zoom_range[2],
           ymin = y_zoom_range[1], ymax = y_zoom_range[2],
           color = "grey80", linetype = "dashed", fill = NA, size = 1) +

   
  annotate("segment", x = 0, y = 0.001, xend = 1190000 *0.34, yend = 0.0013 * 0.94,
           color = "grey80", linetype = "dashed", size = 1) +
  annotate("segment", x = 3000, y = 0, xend = 1190000 * 0.86, yend = 0.0013 * 0.22,
           color = "grey80", linetype = "dashed", size = 1)+ 
...
combined_plot
ggsave(filename = "pp1.pdf", plot = combined_plot, device = "pdf", width = 6, height = 4)
```
