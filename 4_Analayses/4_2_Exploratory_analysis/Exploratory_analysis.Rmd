...
pd_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ pd + gp(Latitude, Longitude),
     phi ~ pd ,
     zi ~ pd),
  data = pddata,
...
```{r}
ame_beta_zi_pd_bts %>% mean_hdi(draw)
...
pd_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ pd+ gp(Latitude, Longitude),
     phi ~ pd,
     zi ~ pd),
  data = pddata,
  family = zero_inflated_beta(),
...
gdp_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ GDP_per_capita+ gp(Latitude, Longitude),
     phi ~ GDP_per_capita,
     zi ~ GDP_per_capita),
  data = gdpdata,
  family = zero_inflated_beta(),
...
gdp_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ GDP_per_capita + gp(Latitude, Longitude),
     phi ~ GDP_per_capita,
     zi ~ GDP_per_capita),
  data = gdpdata,
  family = zero_inflated_beta(),
...
rd_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ R_D+ gp(Latitude, Longitude),
     phi ~ R_D,
     zi ~ R_D),
  data = rddata,
  family = zero_inflated_beta(),
...
rd_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ R_D + gp(Latitude, Longitude),
     phi ~ R_D,
     zi ~ R_D),
  data = rddata,
  family = zero_inflated_beta(),
...
edu_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ average_years_of_schooling+ gp(Latitude, Longitude),
...
edu_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ average_years_of_schooling + gp(Latitude, Longitude),
     phi ~ average_years_of_schooling,
     zi ~ average_years_of_schooling),
  data = edudata,
  family = zero_inflated_beta(),
...
urban_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ Urbanization+ gp(Latitude, Longitude),
     phi ~ Urbanization,
     zi ~ Urbanization),
  data = urbandata,
  family = zero_inflated_beta(),
...
urban_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ Urbanization + gp(Latitude, Longitude),
     phi ~ Urbanization,
     zi ~ Urbanization),
  data = urbandata,
  family = zero_inflated_beta(),
...
gi_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ GI+ gp(Latitude, Longitude),
     phi ~ GI,
     zi ~ GI),
  data = gidata,
  family = zero_inflated_beta(),
...
gi_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ GI + gp(Latitude, Longitude),
     phi ~ GI,
     zi ~ GI),
  data = gidata,
  family = zero_inflated_beta(),
...
network_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ Network_2021+ gp(Latitude, Longitude),
     phi ~ Network_2021,
     zi ~ Network_2021),
  data = networkdata,
  family = zero_inflated_beta(),
...
network_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ Network_2021 + gp(Latitude, Longitude),
     phi ~ Network_2021,
     zi ~ Network_2021),
  data = networkdata,
  family = zero_inflated_beta(),
...
ld1_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ lp1+ gp(Latitude, Longitude),
     phi ~ lp1,
     zi ~ lp1),
  data = lddata,
  family = zero_inflated_beta(),
...
ld1_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ lp1 + gp(Latitude, Longitude),
     phi ~ lp1,
     zi ~ lp1),
  data = lddata,
  family = zero_inflated_beta(),
...
ld2_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ lp2+ gp(Latitude, Longitude),
     phi ~ lp2,
     zi ~ lp2),
  data = lddata,
  family = zero_inflated_beta(),
...
```{r}
result <- hypothesis(ame_beta_zi_ld2_bts, "draw>0")
result
result$hypothesis$Estimate
result$hypothesis$CI.Lower
result$hypothesis$CI.Upper
...
ld2_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ lp2 + gp(Latitude, Longitude),
     phi ~ lp2,
     zi ~ lp2),
  data = lddata,
  family = zero_inflated_beta(),
...
english_model_beta_zi_bts <- brm(
  bf(percentage_sample ~ EPI_rank+ gp(Latitude, Longitude),
     phi ~ EPI_rank,
     zi ~ EPI_rank),
  data = englishdata,
  family = zero_inflated_beta(),
...
english_model_beta_zi_ps2014 <- brm(
  bf(ps2014 ~ EPI_rank + gp(Latitude, Longitude),
     phi ~ EPI_rank,
     zi ~ EPI_rank),
  data = englishdata,
  family = zero_inflated_beta(),
...
```{r}
aUS_urbanization_model_beta_zi <- brm(
  bf(Ruggeri_US ~ US_UP_2020,
     phi ~ US_UP_2020,
     zi ~ US_UP_2020),
  ...
  cores = 2, seed = 1234,
  backend = "cmdstanr",
  file = "aUS_urbanization_model_beta_zi "
)
tidy(aUS_urbanization_model_beta_zi, effects = "fixed")
...
```{r}
US_urbanization_model_beta_zi1 <- brm(
  bf(Ruggeri_US_size| trials(size1) ~ US_UP_2020,
   phi ~ US_UP_2020,
     zi ~ US_UP_2020),
  data = US_urbanization,
  family = zero_inflated_beta_binomial(),
  ...
  cores = 4, seed = 1234,
  backend = "cmdstanr",
  file = "US_urbanization_model_beta_zi1"
)
tidy(US_urbanization_model_beta_zi1, effects = "fixed")
...
ame_beta_zi_NL_EPI <- NL_EPI_model_beta_zi %>%
  avg_comparisons(variables = "EPI_NL_2022") %>% 
  posterior_draws()
ame_beta_zi_NL_EPI %>% mean_hdi(draw)
